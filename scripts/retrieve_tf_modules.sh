...
headers.write_text(htext.replace('"python3.9"', '"python3.14"'))

print("MMW patch applied: mosaic-titiler runtime=python3.12 (S3 source); headers lambda runtime=python3.14")
PYEOF